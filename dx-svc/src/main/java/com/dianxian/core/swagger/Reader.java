package com.dianxian.core.swagger;
/**
...
import com.dianxian.core.swagger.jaxrs.ext.SwaggerExtension;
import com.dianxian.core.swagger.jaxrs.ext.SwaggerExtensions;
...
public class Reader {
    ...
    protected Parameter readImplicitParam(ApiImplicitParam param) {
        ...
        if (param.paramType().equalsIgnoreCase("path")) {
            ...
            p = new com.dianxian.core.swagger.parameters.QueryParameter();
    ...
    private List<Parameter> getParameters(Type type, List<Annotation> annotations) {
        ...
        try {
            final List<Parameter> parameters = extension.extractParameters(swagger, annotations, type, typesToSkip, chain);
    ...
    public String extractOperationMethod(ApiOperation apiOperation, Method method, Iterator<SwaggerExtension> chain) {
        if (apiOperation != null && apiOperation.httpMethod() != null && !"".equals(apiOperation.httpMethod())) {
            ...
            return "patch";
        } else if (method.getAnnotation(javax.ws.rs.HttpMethod.class) != null) {
            ...
            return chain.next().extractOperationMethod(swagger, apiOperation, method, chain);
        } else {
            return null;
        }
    }
    ...
    private String getHttpMethodFromCustomAnnotations(Method method) {
        for(Annotation methodAnnotation : method.getAnnotations()){
            javax.ws.rs.HttpMethod httpMethod = methodAnnotation.annotationType().getAnnotation(javax.ws.rs.HttpMethod.class);
            if(httpMethod != null) {
                return httpMethod.value().toLowerCase();
            }
        }
