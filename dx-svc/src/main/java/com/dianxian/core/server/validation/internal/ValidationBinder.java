...
import com.dianxian.core.server.validation.ValidationConfig;
...
public final class ValidationBinder extends AbstractBinder {
    ...
    /**
     * Factory providing default (un-configured) {@link javax.validation.ValidatorFactory} instance.
     */
    ...
    /**
     * Factory providing default (un-configured) {@link javax.validation.Validator} instance.
     */
    ...
    /**
     * Factory providing configured {@link javax.validation.Validator} instance.
     */
    private static class ConfiguredValidatorProvider implements Factory<ConfiguredValidator> {
        ...
        /**
         * Return default {@link javax.validation.ValidatorContext validator context} able to inject JAX-RS resources/providers.
         *
         ...
         */
        private ValidateOnExecutionTraversableResolver getTraversableResolver(TraversableResolver delegate, final ValidateOnExecutionHandler handler) {
            if (delegate == null) {
