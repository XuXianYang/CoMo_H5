...
public final class LocalizationMessages {
    ...
    private final static LocalizableMessageFactory messageFactory = new LocalizableMessageFactory("org.glassfish.server.server.validation.internal.localization");
