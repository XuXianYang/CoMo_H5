 ...
 * presence of {@link javax.validation.executable.ValidateOnExecution} annotation.
 *
 * @author Michal Gajdos
 */
public class ValidateOnExecutionHandler {
     ...
     * @param checkOverrides flag whether overriding/implementing methods should be checked if the {@link javax.validation.executable.ValidateOnExecution}
     * annotation is present.
     */
    public ValidateOnExecutionHandler(final Configuration config, final boolean checkOverrides) {
        this.config = config;
        this.checkOverrides = checkOverrides;
    }

    /**
     * Determine whether the given {@link java.lang.reflect.Method getter} on the given {@link Class clazz} should be validated during the
    ...
    /**
     * Determine whether the given resource {@link java.lang.reflect.Method method} to-be-executed on the given {@link Class clazz} should be
     * validated. The difference between this and {@code #validateGetter} method is that this method returns {@code true} if the
     * {@code method} is getter and validating getter method is not explicitly disabled by {@link javax.validation.executable.ValidateOnExecution} annotation
     ...
     * @param method method to be examined.
     * @param validationMethod method used for cache.
     * @param forceValidation forces validation of a getter if no {@link javax.validation.executable.ValidateOnExecution} annotation is present.
     */
    ...
    /**
     * Process {@link javax.validation.executable.ValidateOnExecution} annotation for given method on a class hierarchy.
     *
     * @param method method to be examined.
    ...
    /**
     * Determine whether the given {@link java.lang.reflect.Method method} should be validated depending on the given {@code executableTypes}.
     *
     * @param method method to be examined.
     * @param allowImplicit allows check for {@link javax.validation.executable.ExecutableType#IMPLICIT} type.
    ...
    /**
     * Return a set of executable types contained in {@link javax.validation.executable.ValidateOnExecution} annotation belonging to the {@code element}.
     *
     * @param element element to be examined for {@link javax.validation.executable.ValidateOnExecution}.
     * @return set of executable types or an empty set if the element is not annotated with {@link javax.validation.executable.ValidateOnExecution}.
     */
    ...
    /**
     * Get a class hierarchy for the given {@code clazz} suitable to be looked for {@link javax.validation.executable.ValidateOnExecution} annotation
