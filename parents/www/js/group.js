    ...
    var dx_group = {
        ...
        renderGrouplist: function (list) {
            ...
            for (var i = 0; i < list.length; i++) {
                html.push('<li>');
                html.push('<a href="talk.html?#' + list[i].id + '" external id="' + list[i].imGroupId + '">');
                html.push('<div class="item-content">');
                html.push('<div class="item-media"><img src="./img/groupicon.png" style="width: 2.2rem;">');
                html.push('<span class="has_new_group_message">.</span>');
                html.push('</div>');
        ...
        addNewMessageTips: function (list) {
            for (var i = 0; i < list.length; i++) {
                ...
                $("#" + list[i].imGroupId + " .has_new_group_message").css("display", blockStyle);
            }
        },
